...
cx = 64
cy = 32
offset = 6     # distance from center to corners
move = 6       # movement amount
...
while True:
    ...
    # BASE positions (reset every frame)
    A = [cx - offset, cy - offset]
    B = [cx + offset, cy - offset]
    C = [cx - offset, cy + offset]
    D = [cx + offset, cy + offset]
